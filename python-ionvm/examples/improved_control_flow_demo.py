...
def create_side_effect_function():
    ...
    return Function(
        name="side_effect_func", arity=0, extra_regs=4, instructions=instructions
    )
...
def create_condition_checker():
    ...
    return Function(
        name="condition_checker", arity=1, extra_regs=6, instructions=instructions
    )
...
def create_if_else_demo():
    ...
    builder.if_condition_lazy(
        [Instruction.load_const(1, Value.number(1)), Instruction.equal(2, 0, 1)], 2
    )

    # First block - no side effects needed
    builder.add_instruction(Instruction.load_const(8, Value.atom("__stdlib:Debug")))
    ...
    builder.elif_condition_lazy(
        [
            Instruction.load_const(
                3, Value.atom("__function_ref:SideEffect:side_effect_func")
            ),
    ...
    builder.add_instruction(
        Instruction.load_const(1, Value.string("Input matched side effect result"))
    )
    builder.add_instruction(Instruction.call(2, 8, [1]))
    ...
    builder.elif_condition_lazy(
        [
            Instruction.load_const(
                6, Value.atom("__function_ref:ConditionChecker:condition_checker")
            ),
    ...
    builder.add_instruction(Instruction.load_const(8, Value.atom("__stdlib:Debug")))
    builder.add_instruction(
        Instruction.load_const(1, Value.string("Condition checker returned true"))
    )
    builder.add_instruction(Instruction.call(2, 8, [1]))
    ...
    builder.add_instruction(Instruction.load_const(8, Value.atom("__stdlib:Debug")))
    builder.add_instruction(
        Instruction.load_const(1, Value.string("No conditions matched"))
    )
    builder.add_instruction(Instruction.call(2, 8, [1]))
    ...
    return Function(
        name="if_else_demo", arity=1, extra_regs=9, instructions=instructions
    )
...
def create_while_then_else_demo():
    ...
    builder.while_condition(
        [
            ...
            Instruction.less_than(2, 0, 1),
        ],
        2,
    )

    # Loop body
    builder.add_instruction(Instruction.load_const(6, Value.atom("__stdlib:Debug")))
    ...
    builder.add_instruction(Instruction.call(8, 6, [0]))
    ...
    # builder.add_instruction(Instruction.load_const(12, Value.atom("__stdlib:Debug")))
    ...
    inner_if2.add_instruction(Instruction.load_const(17, Value.atom("__stdlib:Debug")))
    inner_if2.add_instruction(
        Instruction.load_const(18, Value.string("Continuing at 3"))
    )
    ...
    # Rest of loop body
    builder.add_instruction(Instruction.load_const(20, Value.atom("__stdlib:Debug")))
    builder.add_instruction(
        Instruction.load_const(21, Value.string("-------End of loop body--------"))
    )
    builder.add_instruction(Instruction.call(22, 20, [21]))

    # Then block (normal exit)
    builder.then_block()
    builder.add_instruction(Instruction.load_const(23, Value.atom("__stdlib:Debug")))
    builder.add_instruction(
        Instruction.load_const(24, Value.string("Loop completed normally"))
    )
    ...
    builder.else_block()
    builder.add_instruction(Instruction.load_const(27, Value.atom("__stdlib:Debug")))
    builder.add_instruction(
        Instruction.load_const(28, Value.string("Loop was broken early"))
    )
...
def create_main_function():
    ...
    instructions = [
        ...
        Instruction.load_const(0, Value.atom("__stdlib:Debug")),
        Instruction.load_const(
            1, Value.string("=== Test 1: Input = 1 (should hit first condition) ===")
        ),
        Instruction.call(2, 0, [1]),
        ...
        Instruction.load_const(
            7, Value.string("=== Test 2: Input = 42 (should hit second condition) ===")
        ),
        Instruction.call(8, 6, [7]),
        Instruction.load_const(9, Value.number(42)),
        Instruction.load_const(
            10, Value.atom("__function_ref:IfElseDemo:if_else_demo")
        ),
        ...
        Instruction.load_const(
            13, Value.string("=== Test 3: Input = 7 (should hit third condition) ===")
        ),
        Instruction.call(14, 12, [13]),
        Instruction.load_const(15, Value.number(7)),
        Instruction.load_const(
            16, Value.atom("__function_ref:IfElseDemo:if_else_demo")
        ),
        ...
        Instruction.load_const(
            19, Value.string("=== Test 4: Input = 2 (should hit else block) ===")
        ),
        Instruction.call(20, 18, [19]),
        Instruction.load_const(21, Value.number(2)),
        Instruction.load_const(
            22, Value.atom("__function_ref:IfElseDemo:if_else_demo")
        ),
        Instruction.call(23, 22, [21]),
        # Test 5: while-then-else demo
        Instruction.load_const(24, Value.atom("__stdlib:Debug")),
        Instruction.load_const(
            25, Value.string("=== Test 5: While-then-else demo ===")
        ),
        Instruction.call(26, 24, [25]),
        Instruction.load_const(
            27, Value.atom("__function_ref:WhileDemo:while_then_else_demo")
        ),
        Instruction.call(28, 27, []),
        # Final message
        Instruction.load_const(29, Value.atom("__stdlib:Debug")),
        Instruction.load_const(30, Value.string("All tests completed!")),
        Instruction.call(31, 29, [30]),
        Instruction.return_reg(31),
    ]

    return Function(name="main", arity=0, extra_regs=32, instructions=instructions)
    ...
    try:
        ...
        result = subprocess.run(
            [
                ...
                "run",
                "-d",
                os.path.join("../python-ionvm", ionpack_file),
            ],
            cwd="../vmm",
            capture_output=True,
            text=True,
