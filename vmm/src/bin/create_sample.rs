...
fn create_unified_actors_sample() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let coordinator_function = Function::new_bytecode(
        ...
        vec![
            ...
            Instruction::LoadConst(
                1,
                Value::Primitive(Primitive::Atom("UNIFIED: Starting coordinator".to_string())),
            ),
            Instruction::Call(2, 0, vec![1]),
            // Load the worker function reference for spawning
            Instruction::LoadConst(
                3,
                Value::Primitive(Primitive::Atom("__function_ref:worker".to_string())),
            ),
            ...
            Instruction::LoadConst(
                6,
                Value::Primitive(Primitive::Atom(
                    "UNIFIED: Spawning worker with self reference".to_string(),
                )),
            ),
            ...
            Instruction::LoadConst(
                10,
                Value::Primitive(Primitive::Atom(
                    "UNIFIED: Worker spawned, sending task".to_string(),
                )),
            ),
            ...
            Instruction::LoadConst(
                14,
                Value::Primitive(Primitive::Atom(
                    "UNIFIED: Task sent, waiting for result".to_string(),
                )),
            ),
            ...
            Instruction::LoadConst(
                18,
                Value::Primitive(Primitive::Atom(
                    "UNIFIED: Received result from worker".to_string(),
                )),
            ),
    ...
    let worker_function = Function::new_bytecode(
        ...
        vec![
            ...
            Instruction::LoadConst(
                9,
                Value::Primitive(Primitive::Atom(
                    "UNIFIED: Worker started, coordinator in r0".to_string(),
                )),
            ),
            ...
            Instruction::LoadConst(
                12,
                Value::Primitive(Primitive::Atom(
                    "UNIFIED: Worker received number to square".to_string(),
                )),
            ),
            ...
            Instruction::LoadConst(
                17,
                Value::Primitive(Primitive::Atom(
                    "UNIFIED: Worker computed square".to_string(),
                )),
            ),
            ...
            Instruction::LoadConst(
                22,
                Value::Primitive(Primitive::Atom(
                    "UNIFIED: Worker sent result back to coordinator".to_string(),
                )),
            ),
    ...
    let mut builder = IonPackBuilder::new("unified-actors".to_string(), "1.0.0".to_string())
        ...
        .description(
            "Complete actor model demonstration - both functions in single file".to_string(),
        )
...
fn create_complex_sample() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let main_function = Function::new_bytecode(
        ...
        vec![
            ...
            Instruction::LoadConst(
                1,
                Value::Primitive(Primitive::Atom("__stdlib:PrintLn".to_string())),
            ),
...
fn create_actors_sample() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let worker_function = Function::new_bytecode(
        ...
        vec![
            ...
            Instruction::LoadConst(
                9,
                Value::Primitive(Primitive::Atom(
                    "WORKER: Started, waiting for message".to_string(),
                )),
            ),
            Instruction::Call(10, 8, vec![9]),
            ...
            Instruction::LoadConst(
                12,
                Value::Primitive(Primitive::Atom("WORKER: Received message".to_string())),
            ),
            Instruction::Call(13, 11, vec![12]),
            ...
            Instruction::Mul(3, 1, 1), // r3 = message * 2 (process the message)
            ...
            Instruction::LoadConst(
                17,
                Value::Primitive(Primitive::Atom("WORKER: Processed result".to_string())),
            ),
            Instruction::Call(18, 16, vec![17]),
            ...
            Instruction::LoadConst(
                22,
                Value::Primitive(Primitive::Atom(
                    "WORKER: Sent result back to coordinator".to_string(),
                )),
            ),
            Instruction::Call(23, 21, vec![22]),
    ...
    let main_function = Function::new_bytecode(
        ...
        vec![
            ...
            Instruction::LoadConst(
                1,
                Value::Primitive(Primitive::Atom("MAIN: Starting execution".to_string())),
            ),
            Instruction::Call(2, 0, vec![1]),
            // Step 1: Load worker function reference using special marker for resolution
            Instruction::LoadConst(
                3,
                Value::Primitive(Primitive::Atom("__function_ref:Worker:worker".to_string())),
            ),
            ...
            Instruction::LoadConst(
                5,
                Value::Primitive(Primitive::Atom(
                    "MAIN: Worker function reference loaded".to_string(),
                )),
            ),
            ...
            Instruction::LoadConst(
                9,
                Value::Primitive(Primitive::Atom(
                    "MAIN: About to spawn worker process".to_string(),
                )),
            ),
            Instruction::Call(10, 8, vec![9]),
            ...
            Instruction::LoadConst(
                13,
                Value::Primitive(Primitive::Atom(
                    "MAIN: Successfully spawned worker process".to_string(),
                )),
            ),
            ...
            Instruction::LoadConst(
                17,
                Value::Primitive(Primitive::Atom(
                    "MAIN: About to send message to worker".to_string(),
                )),
            ),
            Instruction::Call(18, 16, vec![17]),
            ...
            Instruction::LoadConst(
                20,
                Value::Primitive(Primitive::Atom(
                    "MAIN: Message sent, now waiting for response".to_string(),
                )),
            ),
            ...
            Instruction::LoadConst(
                24,
                Value::Primitive(Primitive::Atom(
                    "MAIN: Received response from worker".to_string(),
                )),
            ),
